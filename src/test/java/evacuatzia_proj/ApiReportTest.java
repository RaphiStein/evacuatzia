...
public class ApiReportTest {
	...
	public void gettingAllReportsInARectangle() {
		...
		u.createReport("report1", "content", new Geometry(1D, 1D, 1D), new Date());
		u.createReport("report1", "content", new Geometry(4D, 4D, 1D), new Date());
		u.createReport("report1", "content", new Geometry(25D, 25D, 1D), new Date());
